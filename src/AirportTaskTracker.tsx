  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-100 via-cyan-50 to-gray-100 p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
          ...
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex items-center gap-2 bg-gray-100 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-200 transition-all shadow border border-gray-200"
              >
                <Settings size={20} />
                Settings
              </button>
            ...
            <button
              ...
              className={`px-6 py-3 font-semibold rounded-xl transition-all duration-200 shadow ${
                activeTab === 'active'
                  ...
                  : 'bg-white text-gray-600 hover:bg-gray-50 hover:text-gray-800 hover:shadow-md border border-gray-200'
              }`}
            >
        ...
        {activeTab !== 'equipment' && (
        <>
        <div className="bg-white rounded-xl shadow p-4 mb-6 border border-gray-200 no-print">
          <div className="flex flex-wrap gap-3">
            <select
              value={filters.category}
              onChange={(e) => setFilters({...filters, category: e.target.value})}
              className="bg-gray-50 border border-gray-200 text-gray-700 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:border-cyan-400"
            >
        ...
        <div className="space-y-4">
          {filteredTasks.length === 0 ? (
            <div className="bg-white rounded-xl p-12 text-center border border-gray-200 shadow">
            ...
            filteredTasks.map(task => {
              ...
              return (
                <div
                  ...
                  className={`rounded-xl shadow ${isMajorTask ? 'border-2 border-amber-400 bg-gradient-to-br from-amber-50 to-white' : 'bg-white border border-gray-200'} hover:border-cyan-300 hover:shadow-md transition-all task-card ${draggedTask?.id === task.id ? 'opacity-50' : ''}`}
                >
                  <div className="p-5">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-2 mb-2 flex-wrap">
                          ...
                          {task.due_date && (
                            <span className="badge bg-gray-500 text-white px-2 py-1 rounded-lg text-xs font-semibold flex items-center gap-1">
                              <Calendar size={12} />
                    ...
                    {task.subtasks!.map(subtask => {
                      ...
                      return (
                        <div
                          ...
                          className={`bg-gray-50 rounded-lg p-4 border-l-4 border-cyan-400 shadow-sm ${draggedSubtask?.id === subtask.id ? 'opacity-50' : ''}`}
                        >
                          <div className="flex items-start gap-4">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {equipmentList
                ...
                return (
                  <div
                    ...
                    className={`bg-white rounded-xl p-5 border shadow-sm ${isFacility ? 'border-teal-200 hover:border-teal-400' : 'border-gray-200 hover:border-cyan-400'} cursor-pointer transition-all hover:shadow-md`}
                  >
              ...
              {equipmentList.filter(equip => {
                ...
                <div className="col-span-full bg-white rounded-xl p-12 text-center border border-gray-200 shadow">
                  {equipmentViewFilter === 'facilities' ? (
                    <>
        ...
        {activeTab === 'equipment' && selectedEquipment && (
          <div className="space-y-6">
            ...
            <div className={`bg-white rounded-xl p-6 border shadow ${isFacilityType(selectedEquipment.equipment_type) ? 'border-teal-200' : 'border-gray-200'}`}>
              <button
              ...
              <div className="flex items-start justify-between">
                ...
                <button
                  ...
                  className="flex items-center gap-2 bg-gray-100 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-200 transition-colors border border-gray-200"
                >
                  <Edit2 size={18} />
                  Edit
                </button>
              ...
              {getUpcomingServices(selectedEquipment.name).length > 0 ? (
                <div className="space-y-3">
                  {getUpcomingServices(selectedEquipment.name).map(task => (
                    <div key={task.id} className="bg-gray-50 rounded-lg p-4 flex justify-between items-center">
                      <div>
                      ...
                      <button
                        onClick={() => openEditTask(task)}
                        className="text-blue-400 hover:text-blue-300 p-2 hover:bg-gray-100 rounded-lg transition-all"
                      >
                        <Edit2 size={16} />
                      </button>
                    </div>
              ...
              {getCurrentFaults(selectedEquipment.name).length > 0 ? (
                <div className="space-y-3">
                  {getCurrentFaults(selectedEquipment.name).map(task => (
                    <div key={task.id} className="bg-gray-50 rounded-lg p-4 flex justify-between items-center border-l-4 border-red-500">
                      <div>
                        <p className="text-gray-800 font-medium">{task.title}</p>
                        <div className="flex gap-2 mt-1">
                          {task.due_date && (
      ...
      {showEquipmentModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className={`bg-white rounded-xl shadow-2xl max-w-2xl w-full border ${isFacilityType(equipmentForm.equipment_type) ? 'border-teal-200' : 'border-gray-200'} flex flex-col`} style={{maxHeight: 'calc(100vh - 4rem)'}}>
            <div className={`bg-white border-b ${isFacilityType(equipmentForm.equipment_type) ? 'border-teal-200' : 'border-gray-200'} p-6 flex justify-between items-center flex-shrink-0`}>
            ...
            <div className="p-6 space-y-4 flex-1" style={{overflowY: 'auto'}}>
              <div>
                ...
                <input
                  ...
                  className="w-full bg-gray-50 border border-gray-300 text-gray-800 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-cyan-500"
                />
              </div>
            ...
            <div className={`sticky bottom-0 bg-white border-t ${isFacilityType(equipmentForm.equipment_type) ? 'border-teal-200' : 'border-gray-200'} p-4 flex justify-end gap-3 flex-shrink-0`}>
              <button
                onClick={() => setShowEquipmentModal(false)}
                className="bg-gray-50 text-gray-800 px-6 py-2 rounded-lg hover:bg-gray-100 transition-colors"
              >
                Cancel
              </button>
              <button
      ...
      {showTaskModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-2xl max-w-2xl w-full border border-gray-200 flex flex-col" style={{maxHeight: 'calc(100vh - 4rem)'}}>
            ...
            <div className="p-6 flex-1" style={{overflowY: 'auto'}}>
              ...
              <div className="space-y-3 mb-6">
                {currentTaskForRemarks.remarks && currentTaskForRemarks.remarks.length > 0 ? (
                  currentTaskForRemarks.remarks.map(remark => (
                    <div key={remark.id} className="bg-gray-50 rounded-lg p-4 border border-gray-300">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full bg-gray-50 border border-gray-300 text-gray-800 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-cyan-500 mb-3"
                />
                <button
                  onClick={addRemark}
      ...
      {showSettingsModal && (
        <div className="fixed inset-0 flex items-center justify-center z-50 p-4">
          ...
          <div className="bg-white rounded-xl shadow-2xl max-w-4xl w-full border border-gray-200 flex flex-col relative z-50" style={{maxHeight: 'calc(100vh - 4rem)'}}>
            <div className="bg-white border-b border-gray-200 p-6 flex justify-between items-center flex-shrink-0">
              ...
              <div>
                ...
                <div className="flex gap-2 mb-4">
                  <input
                    ...
                    className="flex-1 bg-gray-50 border border-gray-300 text-gray-800 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-cyan-500 placeholder-slate-400"
                  />
                  <button
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                  {teamMembers.map((member) => (
                    <div key={member} className="bg-gray-50 border border-gray-300 rounded-lg p-3 flex justify-between items-center gap-2">
                      <span className="text-gray-800 font-medium">👤 {member}</span>
                      <button
                        onClick={() => removeTeamMember(member)}
                        className="text-red-400 hover:text-red-300 transition-colors p-2 hover:bg-gray-100 rounded cursor-pointer flex-shrink-0"
                        title="Delete"
                      >
                        <Trash2 size={16} />
                      </button>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {equipmentList.map((equip) => (
                    <div key={equip.id} className="bg-gray-50 border border-gray-300 rounded-lg p-3 flex justify-between items-center gap-2">
                      ...
                      <div className="flex gap-1">
                        <button
                          ...
                          className="text-blue-400 hover:text-blue-300 transition-colors p-2 hover:bg-gray-100 rounded cursor-pointer"
                          title="Edit"
                        >
                          <Edit2 size={16} />
                        </button>
                        <button
                          ...
                          className="text-red-400 hover:text-red-300 transition-colors p-2 hover:bg-gray-100 rounded cursor-pointer"
                          title="Delete"
                        >
                          <Trash2 size={16} />
                        </button>
            ...
            <div className="bg-white border-t border-gray-200 p-4 flex justify-end flex-shrink-0">
              <button
                onClick={() => setShowSettingsModal(false)}
                className="bg-gradient-to-r from-green-500 to-emerald-500 text-white px-6 py-2 rounded-lg hover:from-green-500 hover:to-emerald-500 transition-colors"
              >
      ...
      {showPartsModal && selectedEquipment && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-2xl max-w-3xl w-full border border-gray-200 flex flex-col" style={{maxHeight: 'calc(100vh - 4rem)'}}>
            <div className="bg-white border-b border-gray-200 p-6 flex justify-between items-center flex-shrink-0">
              <div>
                    ...
                    <table className="w-full">
                      ...
                      <tbody>
                        {equipmentParts.map(part => (
                          <tr key={part.id} className="border-b border-gray-200 hover:bg-gray-50/50">
